...
declare class GameMap {
   ...
   * @param fromRoom Start room name or room object.
   * @param toRoom Finish room name or room object.
   * @param opts An object with the following options: This callback accepts two arguments: function(roomName, fromRoomName).
   * It can be used to calculate the cost of entering that room. You can use this to do things like prioritize your own rooms, or avoid some rooms.
...
declare class Market {
   ...
   * @returns Result Code: OK, ERR_NOT_OWNER, ERR_NOT_ENOUGH_RESOURCES, ERR_FULL, ERR_INVALID_ARGS
   */
